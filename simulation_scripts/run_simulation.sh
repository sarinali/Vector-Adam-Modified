...
# for i in {1..10}
# do
#   /Users/sarinali/.local/share/virtualenvs/VectorAdam-rkohprO_/bin/python /Users/sarinali/Projects/VectorAdam/demo2_transport_vs_project.py $i $num_steps>> logs/${current_date}_loss_logs.txt 2>&1
# done
